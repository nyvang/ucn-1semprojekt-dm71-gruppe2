...
public class Salg extends javax.swing.JPanel {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        BetalingKonto betalingKonto1 = new BetalingKonto();
        insertPanel(betalingKonto1);
...
private class BetalingKort extends javax.swing.JPanel {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 616, Short.MAX_VALUE)
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        {
            JOptionPane.showMessageDialog(null, "Du afbryder du salget." , "Afbryde salg",
    ...
    private void hjaelpSalg()
    {
        JOptionPane.showMessageDialog(null, "Send beløb til kortterminalen" +
                "\nSalget kan afbrydes inden betaling er gennemført." +
                "\nSalget skal afsluttes for at det registres."
                 , "Hjælp", JOptionPane.INFORMATION_MESSAGE);
    }
...
public class BetalingKontant extends javax.swing.JPanel
{
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        if(text.equals("er ikke gennemført."))
        {
            JOptionPane.showMessageDialog(null, "Du afbryder nu salget." , "Afbryde salg",
                    JOptionPane.OK_OPTION);
            sales.clearSale();
            setTableRow(0);
            setTableColumn(0);
...
//        c = ??;
    ...
    private void hjaelpSalg()
    {
        JOptionPane.showMessageDialog(null, "Indtast beløb som modtages fra kunden.\nReturbeløbet vises herefter." +
                "\nSalget kan afbrydes inden betaling er gennemført." +
                "\nSalget skal afsluttes for at det registres."
                 , "Hjælp", JOptionPane.INFORMATION_MESSAGE);
    }
 ...
 * BetalingKonto.java
 *
 * Created on 10-06-2010, 14:14:52
 */
 ...
 * @author Anita
 */
public class BetalingKonto extends javax.swing.JPanel {

    /** Creates new form BetalingKonto */
    public BetalingKonto() {
        initComponents();
        setPaymentPanel();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 255, 204));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Betaling på konto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 0, 11))); // NOI18N
        ...
        jLabel1.setText("Find kunde vha tlf.nr.:");
    ...
    private void accountSet()
    {
        ...
        Customer c = new Customer();
        c = sales.getCustomer(i);
        if(c.getPhone() == 0)
        {
            JOptionPane.showMessageDialog(null, "Kundenummeret findes ikke!!" , "Fejl",
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
            JOptionPane.showMessageDialog(null, c.getName() + " har tlf.nr. " + c.getPhone(), "Kunde fundet",
                    JOptionPane.INFORMATION_MESSAGE);
            jTextField18.setText(jTextField3.getText() + " er tilføjet " + c.getName() + "s konto");
        }
    }
    ...
    private void SaleIsFinished()
    {
        ...
        if(text.equals("er ikke gennemført."))
        {
          JOptionPane.showMessageDialog(null, "Kunde er ikke fundet." , "Manglende betaling",
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
    ...
    private void hjaelpSalg()
    {
        JOptionPane.showMessageDialog(null, "Find kunden vha kundens tlf.nr." +
                "\nSalget kan afbrydes inden kunden er fundet." +
                "\nSalget skal afsluttes for at det registres."
                 , "Hjælp", JOptionPane.INFORMATION_MESSAGE);
    }
